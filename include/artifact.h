...
#define SUMMON_FIRE	(LAST_PROP+33)
#define SUMMON_FROST	(LAST_PROP+34)
#define PHASING		(LAST_PROP+35)
#define OBJECT_DET	(LAST_PROP+36)
#define TELEPORT_SHOES	(LAST_PROP+37)
#define LORDLY	(LAST_PROP+38)
#define VOID_CHIME	(LAST_PROP+39)
#define INFINITESPELLS	(LAST_PROP+40)
#define SPIRITNAMES	(LAST_PROP+41)
#define RAISE_UNDEAD	(LAST_PROP+42)
#define FALLING_STARS	(LAST_PROP+43)
#define THEFT_TYPE		(LAST_PROP+44)
#define ANNUL			(LAST_PROP+45)
#define ARTI_REMOVE_CURSE	(LAST_PROP+46)
#define SUMMON_UNDEAD   (LAST_PROP+47)
#define DEATH_GAZE      (LAST_PROP+48)
#define SMITE           (LAST_PROP+49)
#define PROTECT         (LAST_PROP+50)
#define TRAP_DET        (LAST_PROP+51)
#define UNBIND_SEALS    (LAST_PROP+52)
#define HEAL_PETS       (LAST_PROP+53)
#define FREE_SPELL      (LAST_PROP+54)
#define BURN_WARD       (LAST_PROP+55)
#define FAST_TURNING    (LAST_PROP+56)
#define FIRE_BLAST      (LAST_PROP+57)
#define SELF_POISON     (LAST_PROP+58)
#define ADD_POISON      (LAST_PROP+59)
#define TOWEL_ITEMS     (LAST_PROP+60)
#define MAJ_RUMOR       (LAST_PROP+61)
#define ARTIFICE        (LAST_PROP+62)
#define SUMMON_PET      (LAST_PROP+63)
#define LIFE_DEATH      (LAST_PROP+64)
#define PRISMATIC       (LAST_PROP+65)
#define STEAL           (LAST_PROP+66)
#define SUMMON_VAMP     (LAST_PROP+67)
#define COLLECT_TAX     (LAST_PROP+68)
#define ALTMODE         (LAST_PROP+69)
#define AEGIS           (LAST_PROP+70)
#define WATER           (LAST_PROP+71)
#define SINGING         (LAST_PROP+72)
#define WIND_PETS		(LAST_PROP+73)
