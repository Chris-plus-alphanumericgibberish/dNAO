...
#define HELL_FIRE_RES				1 + DRAGON_TRAINER
#define HOLY_FIRE_RES				1 + HELL_FIRE_RES
#define HELL_COLD_RES				1 + HOLY_FIRE_RES
#define HOLY_COLD_RES				1 + HELL_COLD_RES
#define HELL_SHOCK_RES				1 + HOLY_COLD_RES
...
#define SFLM_SPELLS					1 + AERIAL_COMBAT
#define SFLM_MORTAL_SPELLS			1 + SFLM_SPELLS
#define SFLM_UNDEATH_SPELLS			1 + SFLM_MORTAL_SPELLS
#define SFLM_SPIRIT_SPELLS			1 + SFLM_UNDEATH_SPELLS
#define SFLM_WRATH_SPELLS			1 + SFLM_SPIRIT_SPELLS
#define SFLM_ILLUSION_SPELLS		1 + SFLM_WRATH_SPELLS
#define LAST_PROP					(SFLM_ILLUSION_SPELLS)
