...
#define is_flyer_species(ptr)	(((ptr)->mflagsm & MM_FLY) != 0L)
#define is_flyer_mon(mon)		(is_flyer_species((mon)->data) || mon_resistance((mon), FLYING))
#define is_displacer_species(ptr)	(((ptr)->mflagsg & MG_DISPLACEMENT) != 0L)
#define is_displacer_mon(mon)	(is_displacer_species((mon)->data) || mon_resistance((mon), DISPLACED))
#define is_floater_species(ptr)	(((ptr)->mflagsm & MM_FLOAT) != 0L)
#define is_floater_mon(mon)		(is_floater_species((mon)->data) || mon_resistance((mon), LEVITATION))
#define is_swimmer_species(ptr)	(((ptr)->mflagsm & MM_SWIM) != 0L)
#define is_swimmer_mon(mon)		(is_swimmer_species((mon)->data) || mon_resistance((mon), SWIMMING))
...
#define passes_walls_species(ptr)	(((ptr)->mflagsm & MM_WALLWALK) != 0L)
#define passes_walls_mon(mon)	(passes_walls_species((mon)->data) || mon_resistance((mon), PASSES_WALLS))
...
#define regenerates_species(ptr)	(((ptr)->mflagsg & MG_REGEN) != 0L)
#define regenerates_mon(mon)	(regenerates_species((mon)->data) || mon_resistance((mon), REGENERATION))
#define perceives_species(ptr)	(((ptr)->mflagsv & MV_SEE_INVIS) != 0L)
#define perceives_mon(mon)	(perceives_species((mon)->data) || mon_resistance((mon), SEE_INVIS))
#define can_teleport_species(ptr)	(((ptr)->mflagsm & MM_TPORT) != 0L)
#define can_teleport_mon(mon)	(can_teleport_species((mon)->data) || mon_resistance((mon), TELEPORT))
#define control_teleport_species(ptr)	(((ptr)->mflagsm & MM_TPORT_CNTRL) != 0L)
#define control_teleport_mon(mon)	(control_teleport_species((mon)->data) || mon_resistance((mon), TELEPORT_CONTROL))
#define telepathic_species(ptr)		(((ptr)->mflagsv & MV_TELEPATHIC) != 0L)
#define telepathic_mon(mon)	(telepathic_species((mon)->data) || mon_resistance((mon), TELEPAT))
