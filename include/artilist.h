...
A("The Fluorite Octahedron",		BLUE_FLUORITE,		"glowing cobalt eight-sided die",
	4000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_NONE, NON_PM, NON_PM, TIER_D, (ARTG_INHER),
	NO_MONS(),
...
A("The Golden Knight",		BUCKLER,		(const char *)0,
	...
	A_NEUTRAL, NON_PM, NON_PM, TIER_B, (ARTG_INHER),
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(), NOFLAG,
	PROPS(), NOFLAG,
...
A("The Ruinous Descent of Stars",	MORNING_STAR,		"silver-spiked %s",
	8000L, METAL, MZ_DEFAULT, WT_DEFAULT,
	A_CHAOTIC, NON_PM, NON_PM, TIER_A, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH|ARTG_MAJOR|ARTG_FXALGN),
	NO_MONS(),
...
A("Arcor Kerym",					CRYSTAL_SWORD,			"gold-runed craggy and pitted %s",
	...
	A_LAWFUL, NON_PM, PM_ELF, TIER_A, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH|ARTG_MAJOR|ARTG_FXALGN),
	NO_MONS(),
	ATTK(AD_PHYS, 20, 10), NOFLAG,
	PROPS(DRAIN_RES), NOFLAG,
	PROPS(), NOFLAG,
...
A("Aryfaern Kerym",					RUNESWORD,			"sword of crimson-edged darkness",
	...
	A_NEUTRAL, NON_PM, PM_ELF, TIER_A, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH|ARTG_MAJOR|ARTG_FXALGN|ARTA_SHINING),
	NO_MONS(),
...
A("Avenger",						LONG_SWORD,			"winged long sword",
	1000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_NOBLEMAN, NON_PM, TIER_C, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH),
	NO_MONS(),
...
A("The Armor of Khazad-dum",		DWARVISH_MITHRIL_COAT,			(const char *)0,
	2500L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_NOBLEMAN, PM_DWARF, TIER_B, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	NO_ATTK(), NOFLAG,
...
A("Durin's Axe",					AXE,				"silver-rune-inlaid %s",
	4000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_NOBLEMAN, PM_DWARF, TIER_C, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	ATTK(AD_PHYS, 10, 10), (ARTA_SILVER),
	PROPS(DRAIN_RES, SEARCHING), (ARTP_SEEK),
	PROPS(), NOFLAG,
...
A("Glamdring",						ELVEN_BROADSWORD,	(const char *)0,
	2000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_LAWFUL, PM_KNIGHT, PM_DWARF, TIER_C, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH),
	MONS(vsMA(MA_ORC|MA_DEMON)),
...
A("The Palantir of Westernesse",	CRYSTAL_BALL,		(const char *)0,
	8000L, MT_DEFAULT, MZ_DEFAULT, WT_DEFAULT,
	A_CHAOTIC, NON_PM, PM_ELF, TIER_A, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH|ARTG_MAJOR),
	NO_MONS(),
	NO_ATTK(), NOFLAG,
	PROPS(), NOFLAG,
...
A("Sol Valtiva",					TWO_HANDED_SWORD,	(const char *)0,
	4000L, OBSIDIAN_MT, MZ_DEFAULT, WT_DEFAULT,
	A_CHAOTIC, NON_PM, PM_FIRE_GIANT, TIER_B, (ARTG_NOGEN|ARTG_INHER|ARTG_NOWISH),
	NO_MONS(),
