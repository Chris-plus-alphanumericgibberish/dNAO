...
E void FDECL(dochrombite, (struct monst *));
...
E int FDECL(unihorn_troubles, (int *));
E boolean NDECL(cure_one_unihorn_trouble);
...
E int FDECL(use_whip, (struct obj *, struct monst *));
...
E boolean NDECL(parasite_research_ok);
E boolean NDECL(parasite_ok);
E int NDECL(defile_count);
E boolean NDECL(defile_research_ok);
...
E boolean NDECL(reanimation_research_ok);
...
E struct obj *FDECL(mk_chromatic_special, (struct obj *));
...
E int FDECL(count_sanctions, (struct obj *));
E int FDECL(count_holy_sanctifications, (struct obj *));
...
E int FDECL(kinsteal_theft, (struct monst *, int));
...
E int FDECL(madness_adjust_san, (long long int));
E int FDECL(madness_source, (int));
E int FDECL(pm_adjust_san, (int));
...
E void NDECL(confer_gehennom_madnesses);
...
E boolean FDECL(activeFace, (int));
E boolean FDECL(activeRune, (int));
E boolean FDECL(selectedFightingForm, (int));
E int FDECL(getFightingFormSkill, (int));
E const char * FDECL(nameOfMentalEdge, (int));
E const char * FDECL(nameOfBorealFace, (int));
E const char * FDECL(nameOfStormRune, (int));
E const char * FDECL(nameOfFightingForm, (int));
E void NDECL(validateLightsaberForm);
E void NDECL(init_martial_forms);
E boolean FDECL(knownMartialForm, (int));
E void NDECL(unlock_martial_forms);
...
E int NDECL(doBorealFace);
E int NDECL(doStormRune);
#ifdef USE_TRAMPOLI
...
E boolean FDECL(dighole_at, (int,int,BOOLEAN_P));
E boolean FDECL(digfarhole, (BOOLEAN_P,int,int,boolean));
E boolean FDECL(pg_mattock_dig, (int,int));
E boolean FDECL(pg_mattock_digdown, (int,int));
E boolean FDECL(pg_axe_chop, (int,int));
...
E int NDECL(WingGuard_on);
E int NDECL(WingGuard_off);
E void NDECL(wingguard_check);
...
E int FDECL(arm_dr_bonus, (struct obj *, int));
...
E boolean FDECL(has_suppressible_item,(struct monst *));
...
E int FDECL(properties_dr, (struct obj *,int,int,int,int,int,int));
E int FDECL(properties_ac, (struct obj *,int,int,int,int,int));
...
E boolean NDECL(flying_kick_monsters);
E boolean NDECL(divine_banishment);
...
E boolean FDECL(walk_path, (coord *, coord *, boolean (*)(genericptr_t,int,int), boolean (*)(genericptr_t,int,int), genericptr_t));
E boolean FDECL(hurtle_step, (genericptr_t, int, int));
E boolean FDECL(jumping_polearm, (genericptr_t, int, int));
...
E void FDECL(food_extracted, (struct obj *));
...
E void FDECL(mkgrymldroom, (boolean *));
E void FDECL(fill_grymldroom, (struct mkroom *, boolean *));
E void NDECL(mineralize);
E void NDECL(mklev);
...
E struct obj *FDECL(mkwingguard, (int));
...
E void FDECL(mklolthvaultitem_cnt,(struct obj *));
E struct obj * FDECL(mkhellvaultitem,(int));
E void FDECL(mkhellvaultitem_cnt,(struct obj *, int));
E struct obj * NDECL(mkchromaticvaultitem);
E void FDECL(mkchromaticvaultitem_cnt,(struct obj *));
...
E struct mkroom * FDECL(pick_room,(boolean, boolean));
E struct mkroom * FDECL(pick_room_grymld,(boolean, boolean));
...
E long FDECL(mm_displacement, (struct monst *,struct monst *));
...
E boolean FDECL(maybe_vanish,(struct monst *));
...
E void FDECL(set_mon_data_core, (struct monst *, struct permonst *, boolean));
E void FDECL(restore_mon_data, (struct monst *, int));
E void FDECL(mon_refresh_bodyparts, (struct monst *));
E void FDECL(mon_refresh_visible_bodyparts, (struct monst *));
E void FDECL(mon_relevel_bodyparts, (struct monst *, int, int));
E boolean FDECL(injuries_block, (struct monst *, struct attack *));
E int FDECL(mon_body_leg_count, (struct monst *));
E int FDECL(mon_injured_leg_count, (struct monst *));
E boolean FDECL(mon_enough_legs_to_stand, (struct monst *));
E boolean FDECL(could_trip, (struct monst *, struct monst *));
E int FDECL(mon_visible_leg_count, (struct monst *));
E boolean FDECL(all_visible_legs_wounded, (struct monst *));
E int FDECL(injure_random_limbs, (struct monst *, int, const char *));
E boolean FDECL(attack_limb_injurable, (struct monst *, struct attack *));
E int FDECL(injure_attack_limb, (struct monst *, struct attack *, const char *));
E int FDECL(injure_random_legs, (struct monst *, int, const char *));
E boolean FDECL(mon_hobbled, (struct monst *));
E void FDECL(mon_heal_injuries_natural, (struct monst *));
E int FDECL(mon_heal_injuries, (struct monst *, int));
...
E int FDECL(hell_dice, (VOID_ARGS));
E int FDECL(choose_hellish_energy, (VOID_ARGS));
...
E boolean FDECL(has_multi_or_nonweapon_nonkick_attk, (struct monst *));
...
E boolean FDECL(resists_hellfire, (struct monst *));
E boolean FDECL(resists_holyfire, (struct monst *));
E boolean FDECL(resists_cold, (struct monst *));
E boolean FDECL(resists_hellcold, (struct monst *));
E boolean FDECL(resists_holycold, (struct monst *));
...
E boolean FDECL(resists_hellelec, (struct monst *));
E boolean FDECL(resists_holyelec, (struct monst *));
E boolean FDECL(resists_poison, (struct monst *));
E boolean FDECL(resists_acid, (struct monst *));
E boolean FDECL(resists_hellacid, (struct monst *));
E boolean FDECL(resists_holyacid, (struct monst *));
...
E int FDECL(num_horns, (struct monst *));
...
E boolean NDECL(u_variable_wings);
...
E boolean FDECL(should_displace, (struct monst *, coord *, long *, int, xchar, xchar));
...
E void NDECL(init_iksh_na_mutations);
E void NDECL(check_iksh_na_mutations);
E void FDECL(doikshna_gaze, (struct monst *));
...
E void FDECL(open_trophy_reliquary, (struct obj *));
...
E int NDECL(dofire);
E int FDECL(uthrow, (struct obj *, struct obj *, int, boolean, boolean));
E int FDECL(mthrow, (struct monst *, struct obj *, struct obj *, int, int, boolean));
E void FDECL(return_ammo, (genericptr_t, long));
E int FDECL(calc_multishot, (struct monst *, struct obj *, struct obj *, int));
...
E void FDECL(unsuppress_object, (genericptr_t, long));
E void FDECL(attach_unsuppress_timeout, (struct obj *, long));
...
E struct monst *FDECL(make_tomb_herd, (struct obj *,xchar,xchar));
E struct obj *FDECL(tomb_herd_statue, (struct monst *));
E void FDECL(tomb_herd_stow, (struct monst *));
...
E int FDECL(mintrap_core, (struct monst *, boolean));
E int FDECL(mintrap, (struct monst *));
E int FDECL(mintrap_forcebungle, (struct monst *));
...
E void FDECL(minstapetrify, (struct monst *, boolean, boolean));
...
E void FDECL(make_prone, (boolean));
E void FDECL(make_mon_prone, (struct monst *, boolean));
E void FDECL(update_proneness, (struct monst *));
E void NDECL(float_up);
E void FDECL(m_float_up, (struct monst *, boolean));
E boolean NDECL(sokoban_unsolved);
E void FDECL(fill_pit, (int,int));
E boolean NDECL(quest_air_fall);
E int FDECL(float_down, (long, long));
E int FDECL(crash_down, (long, long));
E void FDECL(m_float_down, (struct monst *, boolean));
E void FDECL(m_crash_down, (struct monst *, boolean));
...
E int FDECL(whip_disarm, (struct monst *, struct monst *, struct obj *, int));
E int FDECL(trip_attempt, (struct monst *, struct monst *, int));
E int FDECL(mon_whip_tricks, (struct monst *, struct monst *, struct obj *));
...
E void FDECL(update_mon_vulnerability, (struct monst *,int, boolean));
...
E int FDECL(xattacky, (struct monst *, struct monst *, int, int, long));
E int FDECL(xmeleehity, (struct monst *, struct monst *, struct attack *, struct obj **, int, int, boolean, long));
...
E int FDECL(xstoney, (struct monst *, struct monst *, boolean));
...
E boolean NDECL(cure_monk_target);
...
E void NDECL(perform_widegaze_attacks);
E void NDECL(perform_cloudface_widegaze);
E int NDECL(forward_move);
E int NDECL(bent_move);
E int NDECL(hook_move);
E int NDECL(uturn_move);
E int NDECL(alternated_move);
...
E int FDECL(elemental_dmg_resistance, (struct monst *, struct monst *, int, int));
...
E long FDECL(attk_protection, (struct monst *, struct attack *));
E long FDECL(attk_equip_slot, (struct monst *, struct attack *));
E struct atkbp_set NDECL(find_freehand_set);
E boolean FDECL(has_extra_arms, (struct monst *));
E struct atkbp_set FDECL(fallback_strike_bodypart, (struct monst *, struct attack *));
E struct attack FDECL(pick_counterattack, (struct monst *, struct monst *));
E struct attack FDECL(wielded_weapon_attack, (struct monst *, struct obj *));
...
E int FDECL(destroy_items_sonic, (struct monst *, boolean));
E int FDECL(destroy_items_liquify, (struct monst *, boolean));
...
E int FDECL(hit_with_amalgamated_iwarp, (struct monst *,struct obj *, int, int, int, struct attack *));
