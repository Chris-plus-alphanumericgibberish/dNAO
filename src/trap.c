	...
	while(dist-- > 0 && !used_up) {
		...
		if ((mtmp = m_at(bhitpos.x, bhitpos.y)) != 0) {
			...
			if (tohitval((struct monst *)0, mtmp, (struct attack *)0, singleobj, (struct obj *)0, 1, 0) >= dieroll)
				(void)hmon2point0((struct monst *)0, mtmp, (struct attack *)0, singleobj, (struct obj *)0, TRUE, 0, 0, TRUE, dieroll, FALSE, canseemon(mtmp), &used_up, FALSE);
			...
			if (!u.uinvulnerable){
				...
				if (tohitval((struct monst *)0, &youmonst, (struct attack *)0, singleobj, (struct obj *)0, 1, 0) >= dieroll) {
					...
					(void)hmon2point0((struct monst *)0, &youmonst, (struct attack *)0, singleobj, (struct obj *)0, TRUE, 0, 0, TRUE, dieroll, FALSE, canseemon(mtmp), &used_up, TRUE);
				}
				else if (!Blind)
