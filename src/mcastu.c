...
STATIC_DCL void FDECL(cursetxt2, (struct monst *, struct monst *, boolean));
...
void
cursetxt2(magr, mdef, undirected)
struct monst * magr;
struct monst * mdef;
boolean undirected;
{
 ...
 */
int
xcasty2(magr, mdef, attk, tarx, tary)
struct monst * magr;
struct monst * mdef;
struct attack * attk;
int tarx;
 ...
 */
int
cast_spell2(magr, mdef, attk, spell, tarx, tary)
struct monst * magr;
...
int tary;
{
	/* validate */
	if (!magr) {
		impossible("cast_spell2() called with no caster");
		return MM_MISS;
	}
...
//////////////////////////////////////////////////////////////////////////////////////
	...
	case RECOVER:
		if (youagr) {
			...
			return cast_spell2(magr, mdef, attk, CURE_SELF, tarx, tary);
		}
		else {
	...
	case MON_TIME_STOP:
		if (u.summonMonster || youagr) {
			...
			return cast_spell2(magr, mdef, attk, (mdef ? PSI_BOLT : CURE_SELF), tarx, tary);
		}
		else {
