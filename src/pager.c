...
get_mm_description_of_monster_type(struct monst * mtmp, char * description)
{
	...
	many = append(description, is_flyer_species(ptr)	, "flies"				, many);
	many = append(description, is_floater_species(ptr)	, "floats"				, many);
	many = append(description, is_clinger(ptr)			, "clings to ceilings"	, many);
	many = append(description, is_swimmer_species(ptr)	, "swims"				, many);
	...
	many = append(description, passes_walls_species(ptr), "phases"				, many);
	...
	many = append(description, can_teleport_species(ptr), "teleports"			, many);
	many = append(description, control_teleport_species(ptr)	, "controls teleports"	, many);
...
get_mv_description_of_monster_type(struct monst * mtmp, char * description)
{
	...
	many = append(description, perceives_species(ptr)	, "see invisible"			, many);
	many = append(description, telepathic_species(ptr)	, "telepathy"				, many);
...
char * get_mg_description_of_monster_type(struct monst * mtmp, char * description)
{
	...
	many = append(description, is_displacer_species(ptr), "displacing"				, many);
	...
	many = append(description, regenerates_species(ptr)	, "regenerating"			, many);
