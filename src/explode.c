			...
			if(!isok(bhitpos.x, bhitpos.y)) {
				...
				if (scflags & MAY_HITMON) {
					...
					if (tohitval((struct monst *)0, mtmp, (struct attack *)0, stmp->obj, (struct obj *)0, 1, 0) >= dieroll)
						(void)hmon2point0((struct monst *)0, mtmp, (struct attack *)0, (struct attack *)0, stmp->obj, (struct obj *)0, HMON_FIRED, 0, 0, TRUE, dieroll, FALSE, canseemon(mtmp), &used_up, FALSE);
					else
