...
*/    MON("hobbit", S_HUMANOID,//2
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_WEBS, 1,1),
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(1450, 400, 0, MS_HISS, MZ_HUMAN), MR_POISON, MR_POISON,
...
*/    MON("Archon", S_ANGEL,//33
	...
	/*statue-only monster*/
    MON("god", S_ANGEL,//44
	LVL(77, 7, -37, 77, 77), (G_NOGEN|G_NOCORPSE),
 ...
 */
	...
	LVL(20, 12,-20, 0, -10), (G_HELL|G_NOCORPSE|1),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 4, 8), ATTK(AT_CLAW, AD_PHYS, 4, 8),
	  ...
	  ATTK(AT_BREA, AD_FIRE, 6, 10), NO_ATTK),
...
#undef SEDUCTION_ATTACKS
	...
	LVL(9, 6, -12, 55, -10), (G_HELL|G_NOCORPSE|G_SGROUP|2),//quote needed
	A(ATTK(AT_CLAW, AD_PHYS, 1, 3), ATTK(AT_CLAW, AD_PHYS, 1, 3),
	...
	LVL(9, 15, -11, 40, 9), (G_HELL|G_NOCORPSE|G_SGROUP|2),
	...
	LVL(11, 6, -14, 55, 12), (G_HELL|G_NOCORPSE|2),
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
	...
	LVL(11, 9, -11, 65, -11), (G_HELL|G_NOCORPSE|2),//quote needed courts of woe
	A(ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_CLAW, AD_PHYS, 1, 4),
...
*/	MON("pit fiend", S_DEMON,//19
	LVL(13, 6, -23, 65, 13), (G_HELL|G_NOCORPSE|2),
	A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_CLAW, AD_PHYS, 4, 2),
	...
	LVL(14, 10, -24, 55, 12), (G_HELL|G_NOCORPSE|0),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), 
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_MAGC, AD_MAGM, 2, 6),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 8, -24, 88, 14), (G_HELL|G_NOCORPSE|1), //quote needed
	...
	LVL(16, 5, -22, 75, -14), (G_HELL|G_NOCORPSE|2),
	...
	LVL(16, 12, -39, 99, 19), (G_NOGEN|G_HELL|G_NOCORPSE|0),//Encyc
	A(ATTK(AT_WEAP, AD_PHYS, 4, 2), ATTK(AT_CLAW, AD_PHYS, 4, 2),
	...
	LVL(18, 18, -36, 66, -16), (G_HELL|G_NOCORPSE|0),//quote needed
	A(ATTK(AT_CLAW, AD_PHYS, 3, 4), ATTK(AT_CLAW, AD_PHYS, 3, 4),
	...
	LVL(25, 20, -20, 94, 14), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
*/	//Munkir the white guardian Lion
	...
	MON("Bael", S_DEMON,//46
	LVL(40, 8, -29, 54, 18), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(50, 6, -37, 65, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(56, 14, -25, 80, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(56, 18, -25, 80, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(57, 12, -20, 94, 14), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(60, 6, -23, 75, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
*/	MON("Malcanthet", S_DEMON,//36
	LVL(63, 13, -27, 77, -19), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
# define MLSEDUCTION_ATTACKS \
	...
	LVL(63, 13, -37, 77, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	MLSEDUCTION_ATTACKS,
	...
	LVL(64, 10, -30, 44, 17), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(66, 18, -36, 66, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(66, 9, -39, 99, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(69, 7, -33, 93, 16), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 9, 1), ATTK(AT_WEAP, AD_PHYS, 9, 1), 
...
*/	MON("creature in the ice", S_DEMON,//49
	...
	LVL(74, 9, -29, 54, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(78, 15, -32, 80, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(89, 9, -35, 85, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(90, 8, -24, 100, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
//	  ATTK(AT_TUCH, AD_DRLI, 3, 3), ATTK(AT_MAGC, AD_CLRC, 6, 6)),
	...
	LVL(98, 8, -38, 108, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(99, 3, -29, 99, 19), (G_NOGEN|G_HELL|G_NOCORPSE|0), //quote needed
	...
	LVL(100, 13, -35, 100, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(108, 18, -36, 95, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(30, 12, -25, 100, 0), (G_UNIQ|G_NOGEN),
 ...
 */
	...
	M3_WANTSARTI|M3_WAITFORU|M3_INFRAVISION, CLR_YELLOW),
