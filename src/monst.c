 ...
 */
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,10), ATTK(AT_TUCH, AD_PLYS, 1,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,20), ATTK(AT_TUCH, AD_PLYS, 2,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,30), ATTK(AT_TUCH, AD_PLYS, 3,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,40), ATTK(AT_TUCH, AD_PLYS, 4,10), 
	  ATTK(AT_CLAW, AD_PHYS, 4,2),  ATTK(AT_KICK, AD_STUN, 4,3), 
	  ATTK(AT_MAGC, AD_SPEL, 2,4), ATTK(AT_NONE, AD_GROW, 1,20)),
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,50), ATTK(AT_TUCH, AD_PLYS, 5,10), 
 ...
 */
	...
	LVL(15, 16, -2, 50, -6), (G_GENO|G_SGROUP|2),
 ...
 */
	...
	LVL(8, 16, 5, 40, 8), (G_NOGEN|G_HELL|G_NOCORPSE|G_SGROUP|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	CLR_GREEN),
    MON("naiad", S_NYMPH,//5
	LVL(3, 15, 10, 0, -7), (G_GENO|G_NOHELL|2),
    ...
    MON("oread", S_NYMPH,//9
	LVL(6, 8, -3, 0, 7), (G_GENO|G_NOHELL|2),
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(600, 300, 0, MS_SEDUCE, MZ_HUMAN), 0, 0,
	...
	LVL(7, 12, 0, 70, -10), (G_GENO|G_HELL|2),
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0),
 ...
 */
	...
	LVL(13, 14, 1, 20, 0), (G_GENO|G_NOCORPSE|2),
 ...
 */
	...
	LVL(22, 16, -6, 30, 0), (G_NOHELL|G_SGROUP|G_GENO|1),
...
*/
	...
	LVL(10, 24, -10, 20, -10), (G_SGROUP|G_HELL|2),
 ...
 */
	...
	A(ATTK(AT_GAZE, AD_BLNK, 0, 0), ATTK(AT_TUCH, AD_DREN, 2, 20), /*Drain energy does not do Hitpoint damage*/
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 0, 2*sizeof(long), MS_SILENT, MZ_HUMAN),
...
*/    MON("Archon", S_ANGEL,//33
	LVL(27, 17, -7, 77, 17), (G_NOHELL|G_NOCORPSE|1),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	...
	LVL(27, 17, -7, 77, 17), (G_NOHELL|G_NOCORPSE|1), //needs quote
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_ARRW, AD_SOLR, 7, 1),
	  ATTK(AT_GAZE, AD_BLND, 2, 6), ATTK(AT_MAGC, AD_SPEL, 0, 7),
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_CUSS, MZ_LARGE),
	MR_DRAIN|MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_HUMANOID|M1_SEE_INVIS|M1_REGEN,
	...
	/*statue-only monster*/
    MON("God", S_ANGEL,//44
	LVL(77, 7, -7, 77, 77), (G_NOGEN|G_NOCORPSE),
 ...
 */
	...
	LVL(12, 15, -2, 66, -10), (G_NOCORPSE|G_HELL|0),
 ...
 */
	...
	M1_BREATHLESS|M1_NOEYES|M1_NOHEAD|M1_SEE_INVIS|M1_POIS|M1_TUNNEL, 
	...
	LVL(12, 6, -6, 90, 0), (G_GENO|G_NOHELL|1),
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 12), ATTK(AT_TUCH, AD_TELE, 0, 0),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
 ...
 */
	...
	M2_STALK|M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_NEUTER|M2_NASTY,
	M3_INFRAVISION, CLR_YELLOW),
    MON("yesod sephirah", S_KETER,//13
	LVL(10, 12, 0, 10, 10), (G_NOCORPSE|G_NOGEN),
	A(ATTK(AT_WEAP, AD_PHYS,1,8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	LVL(15, 18, -5, 15, 15), (G_NOCORPSE|G_NOGEN),
	...
	LVL(20, 15, -10, 20, 20), (G_NOCORPSE|G_NOGEN),
	...
	LVL(25, 12, 0, 25, 25), (G_NOCORPSE|G_NOGEN),
	A(ATTK(AT_CLAW, AD_CHKH, 2, 12),
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 200, 0, MS_ARREST, MZ_HUMAN), 0, 0, M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_THICK_HIDE,
	M2_STALK|M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_NEUTER|M2_NASTY|M2_ROCKTHROW,
 ...
 */
	...
	M1_BREATHLESS|M1_AMORPHOUS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|
	  M1_MINDLESS|M1_OMNIVORE|M1_ACID,
	M2_HOSTILE|M2_NEUTER, 0, CLR_GRAY),
    // MON("putrid slime", S_PUDDING,//6
	// LVL(4, 6, 8, 0, 0), (G_GENO|1),
	// A(ATTK(AT_BITE, AD_DCAY, 0, 0),
	  // NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	// SIZ(400, 150, 0, MS_SILENT, MZ_MEDIUM),
	// MR_COLD|MR_ELEC|MR_POISON|MR_ACID|MR_STONE, MR_COLD|MR_ELEC|MR_POISON,
	// M1_BREATHLESS|M1_AMORPHOUS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|
	  // M1_MINDLESS|M1_OMNIVORE|M1_ACID,
	// M2_HOSTILE|M2_NEUTER, 0, CLR_BLACK),
 ...
 */
	...
	LVL(15, 10, -8, 40, -3), (G_NOGEN|G_SGROUP|G_GENO|3),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_CLAW, AD_PHYS, 2, 8),
	  ATTK(AT_CLAW, AD_PHYS, 2, 6), NO_ATTK, NO_ATTK, NO_ATTK),
...
//	M3_INFRAVISIBLE, CLR_WHITE),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 10), ATTK(AT_BITE, AD_DRLI, 1, 12),
	...
	A(ATTK(AT_GAZE, AD_SSEX, 0,0),//ATTK(AT_GAZE, AD_PLYS, 1,  4)
	  ATTK(AT_WEAP, AD_PHYS, 1, 10), ATTK(AT_BITE, AD_DRLI, 1, 12),
	  NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_VAMPIRE, MZ_HUMAN), MR_SLEEP|MR_POISON, 0,
	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_NOPOLY|M2_UNDEAD|M2_STALK|M2_HOSTILE|M2_PNAME|M2_STRONG|
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_PHYS, 2,10), ATTK(AT_GAZE, AD_PLYS, 4,  4),
 ...
 */
	...
	M1_BREATHLESS|M1_HUMANOID|M1_UNSOLID|M1_HIDE|M1_SEE_INVIS,
	M2_NOPOLY|M2_UNDEAD|M2_STALK|M2_HOSTILE, M3_INFRAVISION, CLR_BROWN),
	...
	SIZ(WT_HUMAN, 0, 0, MS_SILENT, MZ_HUMAN),
	MR_COLD|MR_DISINT|MR_SLEEP|MR_POISON|MR_SICK|MR_DRAIN, 0,
	M1_FLY|M1_BREATHLESS|M1_HUMANOID|M1_UNSOLID|M1_HIDE|M1_SEE_INVIS,
...
#undef SEDUCTION_ATTACKS
	...
	LVL(11, 12, -6, 80, -12), (G_HELL|G_NOCORPSE|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
...
*/	MON("pit fiend", S_DEMON,//19
	...
	LVL(14, 10, -4, 55, 12), (G_HELL|G_NOCORPSE|0),
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_WEAP, AD_PHYS, 1, 6), 
	  ATTK(AT_CLAW, AD_PHYS, 1, 4), ATTK(AT_MAGC, AD_MAGM, 2, 6),
	  NO_ATTK, NO_ATTK),
	...
	LVL(15, 8, -4, 88, 14), (G_HELL|G_NOCORPSE|1), //quote needed
	...
	LVL(15, 4, -4, 88, 14), (G_HELL|G_NOCORPSE|1), //quote needed
	A(ATTK(AT_WEAP, AD_VORP, 88, 1), ATTK(AT_WEAP, AD_DRLI, 88, 1),
	  ATTK(AT_BOOM, AD_PHYS, 88, 1), NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_SILENT, MZ_LARGE), MR_FIRE|MR_COLD|MR_POISON, 0,
	M1_FLY|M1_WALLWALK|M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_COLLECT,
	M3_INFRAVISION, CLR_BLACK),
    MON("balrog", S_DEMON,//22
	LVL(16, 5, -2, 75, -14), (G_HELL|G_NOCORPSE|2),
	...
	LVL(25, 20, 0, 94, 14), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
*/	//Munkir the white guardian Lion
	...
	MON("Bael", S_DEMON,//46
	LVL(40, 8, -9, 54, 18), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(56, 14, -5, 80, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(57, 12, 0, 94, 14), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(60, 6, -3, 75, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	M1_SWIM|M1_SEE_INVIS|M1_POIS|M1_SLITHY,
...
*/	MON("Malcanthet", S_DEMON,//36
	LVL(63, 13, -7, 77, -19), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
# define MLSEDUCTION_ATTACKS \
	...
	LVL(63, 13, -7, 77, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	MLSEDUCTION_ATTACKS,
	...
	LVL(64, 10, 0, 44, 17), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(66, 18, -6, 66, -15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(66, 9, -9, 99, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(69, 7, -13, 93, 16), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_PHYS, 9, 1), ATTK(AT_WEAP, AD_PHYS, 9, 1), 
...
*/	MON("creature in the ice", S_DEMON,//49
	...
	LVL(74, 9, -9, 54, 15), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(90, 8, -4, 100, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(96, 10, -66, 96, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
...
//	  ATTK(AT_TUCH, AD_DRLI, 3, 3), ATTK(AT_MAGC, AD_CLRC, 6, 6)),
	...
	LVL(98, 8, -8, 108, 20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(99, 3, -9, 99, 19), (G_NOGEN|G_HELL|G_NOCORPSE|0), //quote needed
	...
	LVL(100, 13, -5, 100, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
	...
	LVL(108, 18, -6, 95, -20), (G_HELL|G_NOCORPSE|G_NOGEN|G_UNIQ),
 ...
 */
    ...
    MON("kraken", S_EEL,//22
	LVL(20, 9, 6, 0, -10), (G_GENO|G_NOGEN),
	A(ATTK(AT_CLAW, AD_PHYS, 2, 4), ATTK(AT_CLAW, AD_PHYS, 2, 4),
 ...
 */
	...
	LVL(7, 2, -20, 0, 0), (G_GENO|3),
	A(ATTK(AT_BITE, AD_PHYS, 4, 6), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN*10, 40000, 0, MS_SILENT, MZ_GIGANTIC), 0, 0,
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_THICK_HIDE|M1_NOHANDS|
 ...
 */
	...
	LVL(5, 0, 0, 0, -10), (G_GENO|G_LGROUP|1),
	...
	LVL(12, 2, 10, 0, 0), (G_NOHELL|G_GENO|G_NOCORPSE|G_SGROUP|1),
	...
	A(ATTK(AT_BOOM, AD_MAND, 0, 0), NO_ATTK,
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(2, 400, 0, MS_SILENT, MZ_TINY), MR_SICK|MR_POISON|MR_STONE|MR_DRAIN, MR_POISON,
	M1_BREATHLESS|M1_NOEYES|M1_NOLIMBS|M1_NOHEAD|M1_MINDLESS|M1_NOTAKE,
 ...
 */
	...
	A(ATTK(AT_WEAP, AD_COLD, 1, 8), ATTK(AT_WEAP, AD_PHYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 1, 6), ATTK(AT_MAGC, AD_MAGM, 1, 6), 
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN, 400, 0, MS_HUMANOID, MZ_HUMAN), 0, 0,
	M1_HUMANOID|M1_OMNIVORE,
 ...
 */
	...
	LVL(19, 12, 0, 30, -14), (G_NOGEN|G_UNIQ),
 ...
 */ MON("Tiamat", S_DRAGON,//17
	LVL(13, 6, 6, 20, -10), (G_GENO|G_NOCORPSE|G_UNIQ),
 ...
 */
	...
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_MINDLESS|M1_HUMANOID|M1_THICK_HIDE|M1_POIS,
	M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_COLLECT|M2_NEUTER, 0, HI_LORD),
   MON("alhoon", S_LICH,//25
	...
	A(ATTK(AT_CLAW, AD_PHYS, 400, 1), ATTK(AT_GAZE, AD_WISD, 1, 10), /*You might survive one melee hit from cthulhu, but prob not two*/
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN*10, 4000, 0, MS_HISS, MZ_GIGANTIC), 
	MR_ACID|MR_POISON|MR_FIRE|MR_COLD|MR_DISINT|MR_ELEC|MR_STONE, 0,
	...
	M3_INFRAVISION|M3_OPAQUE, CLR_GREEN),
    MON("Axus", S_EYE,//12 //description needed
	LVL(10, 0, 0, 100, 10), (G_NOGEN|G_UNIQ),
	A(ATTK(AT_NONE, AD_AXUS, 2,12), ATTK(AT_NONE, AD_GROW, 1,20), 
	  NO_ATTK, NO_ATTK,
	  NO_ATTK, NO_ATTK),
	SIZ(10000, 10000, 0, MS_SILENT, MZ_GIGANTIC), MR_ALL, MR_SLEEP,
	M1_AMPHIBIOUS|M1_BREATHLESS|M1_SEE_INVIS|M1_HUMANOID,
	M2_NOPOLY|M2_NEUTER|M2_NASTY|M2_PNAME|M2_PRINCE,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_OPAQUE, HI_LORD),
	...
	MR_FIRE|MR_COLD|MR_ELEC|MR_SLEEP|MR_POISON, 0,
	M1_BREATHLESS|M1_HUMANOID|M1_THICK_HIDE|M1_POIS,
	M2_NOPOLY|M2_PNAME|M2_HOSTILE|M2_STRONG|M2_FEMALE, M3_WAITFORU|M3_INFRAVISION, HI_LORD),
	MON("Lucifer", S_DEMON,//49
	LVL(39, 19, -13, 99, 10), (G_NOCORPSE|G_NOGEN|G_UNIQ),
	A(ATTK(AT_WEAP, AD_SHRD, 2,8), ATTK(AT_WEAP, AD_SHRD, 2,8),
	  ATTK(AT_WEAP, AD_VORP, 2,8), ATTK(AT_WEAP, AD_VORP, 2,8),
