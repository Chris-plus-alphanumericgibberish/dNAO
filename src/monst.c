 ...
 */
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,10), ATTK(AT_GAZE, AD_STDY, 1,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,20), ATTK(AT_GAZE, AD_STDY, 2,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,30), ATTK(AT_GAZE, AD_STDY, 3,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,40), ATTK(AT_GAZE, AD_STDY, 4,10), 
	...
	A(ATTK(AT_NONE, AD_PLYS, 1,50), ATTK(AT_GAZE, AD_STDY, 5,10), 
 ...
 */
	...
	CLR_GREEN),
    MON("naiad", S_NYMPH,//5
	LVL(5, 15, 10, 0, -7), (G_GENO|G_NOHELL|2),
	A(ATTK(AT_CLAW, AD_SITM, 0, 0), ATTK(AT_CLAW, AD_SEDU, 0, 0), 
 ...
 */
	...
	LVL(20, 36, 7, 30, 0), (G_GENO|G_NOCORPSE|G_NOGEN),
	A( ATTK(AT_WEAP, AD_PHYS, 2, 6), ATTK(AT_WEAP, AD_PHYS, 2, 6),
     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
...
# define MLSEDUCTION_ATTACKS \
	...
	LVL(63, 12, -8, 80, -18), (G_HELL|G_NOCORPSE|2),
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4)),
 ...
 */
   ...
   MON("alhoon", S_LICH,//25
	...
	A(ATTK(AT_LRCH, AD_AXUS, 10, 1), ATTK(AT_NONE, AD_AXUS, 1,100), 
	  ATTK(AT_GAZE, AD_STDY, 10,10), ATTK(AT_NONE, AD_GROW, 1,1), 
	  NO_ATTK, NO_ATTK),
	...
	A(ATTK(AT_MAGC, AD_OONA, 0,6), ATTK(AT_NONE, AD_OONA, 20, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(WT_ELF, 350, 0, MS_HUMANOID, MZ_HUMAN), MR_DRAIN|MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE|M1_SEE_INVIS,
	M2_ELF|M2_STRONG|M2_PRINCE|M2_FEMALE,
	M3_INFRAVISIBLE|M3_INFRAVISION, CLR_WHITE),
