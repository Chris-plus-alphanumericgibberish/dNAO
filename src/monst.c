 ...
 */
	...
	A(ATTK(AT_NONE, AD_PLYS, 1, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(30, 10, sizeof(long), MS_SILENT, MZ_TINY),
 ...
 */
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(100, 0, sizeof(long), MS_SILENT, MZ_SMALL), MR_DRAIN|MR_STONE|MR_POISON|MR_SICK, 0,
	...
	A(ATTK(AT_CLAW, AD_PHYS, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(90, 0, sizeof(long), MS_SILENT, MZ_SMALL), MR_DRAIN|MR_STONE|MR_POISON|MR_SICK, 0,
	...
	A(ATTK(AT_EXPL, AD_PHYS, 3, 6), ATTK(AT_BOOM, AD_PHYS, 3, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(10, 0, sizeof(long), MS_SILENT, MZ_SMALL), MR_DRAIN|MR_STONE|MR_POISON|MR_SICK, 0,
	...
	A(ATTK(AT_CLAW, AD_FRWK, 2, 6), ATTK(AT_BOOM, AD_FRWK, 2, 6),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(40, 0, sizeof(long), MS_SILENT, MZ_SMALL), MR_DRAIN|MR_STONE|MR_POISON|MR_SICK, 0,
	M1_MINDLESS, M2_CLOCK|M2_HOSTILE|M2_NOPOLY,
	0, CLR_GRAY),
    MON("gnome", S_GNOME,//3
	...
	A(ATTK(AT_BUTT, AD_PHYS, 2, 8), ATTK(AT_BUTT, AD_PHYS, 2, 8),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(9000, 0, sizeof(long), MS_SILENT, MZ_SMALL), MR_DRAIN|MR_STONE|MR_POISON|MR_SICK, 0,
 ...
 */
	...
	A(ATTK(AT_TUCH, AD_COLD, 1,10), ATTK(AT_TUCH, AD_PLYS, 1, 10),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1200, 100, sizeof(long), MS_MUMBLE, MZ_HUMAN),//75% Flare -> paralize -> warp -> death touch
	MR_COLD|MR_SLEEP|MR_POISON, MR_COLD,
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_UNDEAD|M2_HOSTILE|M2_MAGIC, M3_INFRAVISION, CLR_BROWN),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4)),
	SIZ(WT_HUMAN, 400, sizeof(long), MS_CUSS, MZ_HUMAN), MR_FIRE|MR_COLD|MR_POISON, 0,//37% Firaga->blind->firaga->blind->firaga->stun->firaga->stun
	M1_HUMANOID|M1_SLITHY|M1_SEE_INVIS|M1_POIS,
	M2_DEMON|M2_STALK|M2_HOSTILE|M2_NASTY|M2_FEMALE|M2_COLLECT,
	M3_INFRAVISIBLE|M3_INFRAVISION|M3_TRAITOR, CLR_RED),
	...
	A(ATTK(AT_BITE, AD_PHYS, 3, 8), ATTK(AT_BITE, AD_PHYS, 3, 8),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_DRAGON, 1500, sizeof(long)*2, MS_ROAR, MZ_GIGANTIC), MR_POISON|MR_ELEC|MR_FIRE|MR_COLD, MR_POISON,//50% Scourge->Blizzara->Thundara->Fira
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN*3, 400, sizeof(long)*3, MS_CUSS, MZ_LARGE), MR_ALL, 0,//33% Blizzaga -> Slowra -> Thundaga -> Curaja -> Haste -> Firaga -> Blizzara -> Flare
