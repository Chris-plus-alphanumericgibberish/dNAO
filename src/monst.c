 ...
 */
	...
	M2_MINION|M2_HOSTILE|M2_STRONG, M3_INFRAVISIBLE, CLR_MAGENTA),
/*
...
*/
	...
	LVL(30, 18, -10, 90, 0), (G_NOHELL|G_NOCORPSE|1), //needs quote
 ...
 */
	...
	LVL(18, 15, 2, 10, 15), (G_GENO|1),
	A(ATTK(AT_WEAP, AD_PHYS, 1,10), ATTK(AT_WEAP, AD_PHYS, 1,10),
	  ATTK(AT_BITE, AD_CORR, 3, 8), ATTK(AT_KICK, AD_WEBS, 1, 1), 
	  ATTK(AT_MAGC, AD_CLRC, 6, 3), ATTK(AT_NONE, AD_ACID, 2, 12)),
	SIZ(2550, 500, 0, MS_HUMANOID, MZ_MEDIUM), MR_SLEEP, MR_SLEEP,
	M1_HUMANOID|M1_OMNIVORE, M2_HOSTILE|M2_ELF|M2_STRONG|M2_GREEDY|M2_COLLECT|M2_FEMALE,
	M3_INFRAVISIBLE|M3_DARKSIGHT, CLR_WHITE),
/*
 ...
 */
	...
	A(ATTK(AT_BITE, AD_PHYS, 1, 4),
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(200, 250, 0, MS_SILENT, MZ_MEDIUM), 0, 0,
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
 ...
 */
	...
	A(ATTK(AT_TUCH, AD_COLD, 1,10), ATTK(AT_TUCH, AD_PLYS, 1, 10),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	SIZ(1200, 100, 0, MS_MUMBLE, MZ_HUMAN),//75% Flare -> paralize -> warp -> death touch
	MR_COLD|MR_SLEEP|MR_POISON, MR_COLD,
	M1_BREATHLESS|M1_HUMANOID|M1_POIS|M1_REGEN,
	M2_UNDEAD|M2_HOSTILE|M2_MAGIC|M2_MALE|M2_PNAME, M3_INFRAVISION, CLR_BROWN),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4),
	  ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4)),
	SIZ(WT_HUMAN, 400, 0, MS_CUSS, MZ_HUMAN), MR_FIRE|MR_COLD|MR_POISON, 0,//37% Firaga->blind->firaga->blind->firaga->stun->firaga->stun
	M1_HUMANOID|M1_SLITHY|M1_SEE_INVIS|M1_POIS,
	...
	SIZ(1800, 1000, 0, MS_SILENT, MZ_HUGE), MR_ELEC, 0,//37% Thundara or 15% blind
	M1_SWIM|M1_AMPHIBIOUS|M1_ANIMAL|M1_NOHANDS|M1_CARNIVORE,
	M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_MALE|M2_PNAME, M3_INFRAVISIBLE, CLR_GREEN),
	...
	M2_NOPOLY|M2_HOSTILE|M2_STRONG|M2_NASTY|M2_GREEDY|M2_FEMALE|M2_PNAME|M2_JEWELS|M2_MAGIC, 0, CLR_GREEN),
	...
	A(ATTK(AT_WEAP, AD_PHYS, 4, 4), ATTK(AT_WEAP, AD_PHYS, 4, 4),//Attack routine sometimes replaced by ATTK(AT_MAGC, AD_SPEL, 0, 0)
	  ...
	  NO_ATTK, NO_ATTK),
	SIZ(WT_HUMAN*3, 400, 0, MS_CUSS, MZ_LARGE), MR_ALL, 0,//33% Blizzaga -> Slowra -> Thundaga -> Curaja -> Haste -> Firaga -> Blizzara -> Flare
