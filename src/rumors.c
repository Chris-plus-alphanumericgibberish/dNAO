					...
					case GLIMPSE_ABYSS:
						if (rn2(3)){
							switch (dungeon_topology.brine_variant){ // demo, dagon, lamashtu
								...
								break;
								case LAMASHTU_LEVEL:
									pline("They say that the depths of the Abyss can drive twist even the brightest lights.");
								break;
								break;
							...
							switch (dungeon_topology.abys2_variant){ // orcus, mal, grazzt, lolth
								...
								break;
								case LOLTH_LEVEL:
									if (urole.cgod == GOD_LOLTH && u.ualign.type == A_CHAOTIC) pline("The symbol you bear has been more common around here lately.");
